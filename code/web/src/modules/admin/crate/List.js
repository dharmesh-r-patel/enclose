...
// App Imports
import {
  getList as getCrateList,
  remove as removeCrate,
...
class List extends PureComponent {
  ...
  remove = (id) => {
    if (id > 0) {
      let check = confirm("Are you sure you want to delete this enclose?");
          ...
          .then((response) => {
            if (response.status === 200) {
              if (response.data.errors && response.data.errors.length > 0) {
                ...
                this.props.messageShow("Enclose deleted successfully.");
  ...
  render() {
    ...
    return (
      <div>
        {/* SEO */}
        <Helmet>
          <title>Enclose - Admin - Enclose</title>
        </Helmet>
              ...
              <table className="striped">
                ...
                <tbody>
                  {isLoading ? (
                    ...
                    <tr>
                      <td colSpan="6">
                        <EmptyMessage message="No enclose to show." />
                      </td>
                    </tr>
                  )}
                </tbody>
