  ...
  render() {
    return (
      <div>
        {/* SEO */}
        <Helmet>
          <title>Enclose for everyone! - Enclose</title>
        </Helmet>

        {/* Top title bar */}
        <Grid style={{ backgroundColor: grey }}>
          <GridCell style={{ padding: "2em", textAlign: "center" }}>
            <H3 font="secondary">Enclose for everyone!</H3>

            <p style={{ marginTop: "1em", color: grey2 }}>
              You can choose enclose which suits your need. You can also
              subscribe to multiple enclose.
            </p>
          </GridCell>
        </Grid>
