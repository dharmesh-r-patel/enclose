  ...
  render() {
    return (
      <div>
        {/* SEO */}
        <Helmet>
          <title>My Subscriptions - Enclose</title>
        </Helmet>
        ...
        <Grid style={{ backgroundColor: grey }}>
          <GridCell style={{ padding: "2em", textAlign: "center" }}>
            ...
            <p style={{ marginTop: "1em", color: grey2 }}>
              The enclose you are subscribed to are listed here. You can cancel
              anytime.
            </p>
          </GridCell>
        </Grid>
        ...
        <Grid>
          <GridCell>
            {this.props.subscriptions.isLoading ? (
              ...
              <EmptyMessage message="You are not subscribed to any enclose yet." />
            )}
          </GridCell>
        </Grid>
      </div>
